    ...
    <div class="mx-8 py-8">
        ...
        <table class="table-fixed font-SourceSansPro text-white mt-8">
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tg-0lax">Lorem ipsum dolor.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="tg-0lax">Lorem.</td>
                </tr>
                <tr>
                    <td class="tg-0lax">Alamat</td>
                    <td class="tg-0lax">Lorem ipsum dolor sit amet.</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td class="tg-0lax">Lorem, ipsum.</td>
                </tr>
            </tbody>
        </table>
        ...
        <div class="mt-8">
            ...
            <button class="bg-kuning w-32 rounded-md py-1">
                <a href="" class="text-biru font-Montserrat font-bold">Lanjut</a>
            </button>
        </div>
    </div>
</div>