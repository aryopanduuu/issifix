    ...
    <div class="mx-4 py-4">
        <div class="flex justify-between space-x-8 align-middle items-center">
            <div class="font-Montserrat">
                <h1 class="font-bold text-lg">Peserta Sudah Bayar</h1>
                <h2 class="text-sm">{{ $sudahbayarPeserta ?? "Not Found" }}</h2>
            </div>
            <div>
                <div>
        ...
        <a href="#" class="mt-4 flex items-center space-x-2 nav-toggler" data-target="#bayar">
        ...
        <div id="bayar" class="mt-4 hidden">
